// productos.js SIMPLIFICADO y FUNCIONAL sobre tu base original const URL_CSV = "https://docs.google.com/spreadsheets/d/e/2PACX-1vS4jvq-eB9Fn1bZQjdtiboCyn-0sGswn24iWNdJsWqw0MCz0AOhNoId6BKw8ZLFSg/pub?output=csv";
...
fetch(URL_CSV) .then(res => res.text()) .then(csv => { const filas = csv.split("\n").slice(1); // omitir encabezado const contenedor = document.getElementById("contenedor-productos");
